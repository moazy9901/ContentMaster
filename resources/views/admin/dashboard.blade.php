...
@section('content')
    <div class="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 gap-6">
        ...
        <!-- addresses Card -->
        <div
            class="bg-white rounded-xl shadow-md border-l-4 border-purple-500 p-6 hover:shadow-lg transition-shadow duration-200">
            <div class="flex items-center justify-between">
                <div>
                    <p class="text-sm text-gray-500 uppercase tracking-wide">addresses</p>
                    <p class="text-3xl font-bold text-gray-800">{{ $addressesCount }}</p>
                </div>
                <div
                    class="bg-purple-100 text-purple-600 p-3 rounded-full flex items-center justify-center shadow-sm text-lg">
                    📂
                </div>
            </div>
        </div>
